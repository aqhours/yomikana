...
const cl = (markup: string, zh: string, aside = false): LyricLine => ({
  words: markup.split("|").filter(Boolean).map((token) => {
    ...
    return yw(romaji, compactWordMeanings[surface] ?? wordMeanings[meaningKey(romaji)] ?? "歌词表达", ...jp);
  }),
  zh,
  aside,
});
...
const aozoraJumpingHeartLyrics: LyricLine[] = [
  { words: [yw("mi-ta-ko-to-na-i", "前所未见的", s("見", "み"), s("たことない")), yw("yu-me-no", "梦想的", s("夢", "ゆめ"), s("の")), yw("ki-do-u", "轨道", s("軌道", "きどう"))], zh: "追寻前所未见的" },
  { words: [yw("o-i-ka-ke-te", "追寻着", s("追", "お"), s("いかけて"))], zh: "梦想轨道" },
  { words: [yw("Shining road", "闪耀之路", s("Shining road"))], zh: "Shining road", aside: true },
  { words: [yw("ha-shi-ri-da-su", "飞奔而出", s("走", "はし"), s("りだす")), yw("ko-no", "这份", s("この")), yw("ki-mo-chi", "心情", s("気持", "きも"), s("ち"))], zh: "随着这份心情飞奔而出" },
  { words: [yw("ma-s-su-gu-ni", "笔直地", s("まっすぐに")), yw("i-ki-o-i-yo-ku", "满怀干劲", s("勢", "いきお"), s("いよく"))], zh: "满怀干劲笔直向前" },
  { words: [yw("ki-mi-o", "你", s("君", "きみ"), s("を")), yw("sa-ga-shi-te-ta-yo", "一直寻找着", s("探", "さが"), s("してたよ"))], zh: "一直寻找着你" },
  { words: [yw("cho-t-to", "稍等", s("ちょっと")), yw("ma-t-te", "等待", s("待", "ま"), s("って")), yw("nan-te", "之类的话", s("なんて")), yw("mu-ri", "办不到", s("ムリ"))], zh: "没办法稍等片刻" },
  { words: [yw("to-bi-da-so-u", "飞腾而出吧", s("飛", "と"), s("びだそう"))], zh: "现在就想飞腾而出" },
  { words: [yw("bo-ku-ta-chi-no", "我们的", s("僕", "ぼく"), s("たちの")), yw("na-ka-no", "心中的", s("なかの")), yw("yu-u-ki-ga", "勇气", s("勇気", "ゆうき"), s("が")), yw("sa-wa-i-de-ru", "蠢蠢欲动", s("さわいでる"))], zh: "我们心中的勇气在蠢蠢欲动" },
  { words: [yw("i-tsu-mo-no", "一如往常的", s("いつもの")), yw("se-ka-i-ga", "世界", s("セカイが")), yw("a-ta-ra-shi-i", "崭新的", s("あたらしい")), yw("to-bi-ra-o", "门扉", s("扉", "とびら"), s("を"))], zh: "一如往常的世界其实隐藏着" },
  { words: [yw("mo-t-to", "更多", s("（もっと）")), yw("ka-ku-shi-te-ru-no", "隐藏着", s("隠", "かく"), s("してるの"))], zh: "更多的崭新门扉" },
  { words: [yw("Let's go", "让我们出发", s("（Let's go）")), yw("ze-n-bu", "全部", s("ぜんぶ")), yw("a-ke-ta-i-yo", "想推开", s("開", "あ"), s("けたいよ"))], zh: "全部我都想推开" },
  { words: [yw("ho-ra", "来吧", s("ほら")), yw("i-s-sho-ni-ne", "一起来", s("いっしょにね"))], zh: "和我们一起来" },
  aozoraStartStoryLine,
  { words: [yw("sa-a-i-ma-da", "就现在", s("（さあっいまだ）")), yw("a-o-i", "湛蓝的", s("青", "あお"), s("い")), yw("so-ra-ga", "天空", s("空", "そら"), s("が")), yw("ma-t-te-ru", "正在等待", s("待", "ま"), s("ってる"))], zh: "(就现在)那片蓝天在等着我们" },
  aozoraJumpingHeartLine,
  aozoraTomorrowLine,
  aozoraYouthLine,
  { words: [yw("ha-ji-ma-t-ta", "起航", s("はじまった")), yw("to-ki-no", "时刻的", s("時", "とき"), s("の")), yw("sunshine story", "阳光故事", s("（sunshine story）"))], zh: "梦想起航时" },
  aozoraTokimekiLine,
  aozoraCatchDreamLine,
  { words: [yw("do-n-na-ko-to-ga", "怎样的事情", s("どんなことが")), yw("o-ko-ru-no-ka", "会发生", s("おこるのか"))], zh: "虽然不知道未来会怎样" },
  { words: [yw("wa-ka-ra-na-i-no-mo", "不知道也是", s("わからないのも")), yw("ta-no-shi-mi-sa", "乐趣所在", s("楽", "たの"), s("しみさ"))], zh: "这种未知也是乐趣所在" },
  { words: [yw("Open mind", "敞开心扉", s("Open mind"))], zh: "Open mind", aside: true },
  { words: [yw("tsu-ta-e-na-kya", "若不开口传达", s("伝", "つた"), s("えなきゃ")), yw("tsu-ta-wa-ra-na-i", "便无法传达", s("伝", "つた"), s("わらない"))], zh: "若不开口 要如何传达所思所想" },
  { words: [yw("sa-i-sho-ka-ra", "从一开始", s("最初", "さいしょ"), s("から"))], zh: "没有人从一开始" },
  { words: [yw("ka-n-pe-ki-ni", "十全十美地", s("カンペキに")), yw("de-ki-ru", "能够做到", s("できる")), yw("ha-zu-wa-na-i-ka-ra", "本就不可能", s("筈", "はず"), s("はないから"))], zh: "就是十全十美的" },
  { words: [yw("to-ri-a-e-zu", "暂且先", s("とりあえず")), yw("ge-n-ki-ni", "神采奕奕地", s("元気", "げんき"), s("に")), yw("to-bi-da-so-u", "飞驰而出吧", s("飛", "と"), s("びだそう"))], zh: "暂且先神采奕奕飞驰而出" },
  { words: [yw("bo-ku-ta-chi-no", "我们的", s("僕", "ぼく"), s("たちの")), yw("start line", "起跑线", s("スタートライン"))], zh: "我们的起跑线" },
  { words: [yw("goal-wa", "终点", s("ゴールは")), yw("to-o-i-ka-na", "是否还很遥远", s("遠", "とお"), s("いかな"))], zh: "终点是否还很遥远" },
  { words: [yw("ma-bu-shi-i", "闪耀的", s("まぶしい")), yw("se-ka-i-de", "世界里", s("セカイで"))], zh: "在这个闪耀的世界" },
  { words: [yw("yo-bu", "呼唤", s("呼", "よ"), s("ぶ")), yw("ko-e-ga", "声音", s("声", "こえ"), s("が")), yw("ki-ko-e-ta", "听见了", s("聞", "き"), s("こえた"))], zh: "我听见呼唤我的声音" },
  { words: [yw("mo-t-to", "更多", s("（もっと）")), yw("ki-i-te-mi-ta-ku-te", "想要试着聆听", s("聞", "き"), s("いてみたくて"))], zh: "还想要聆听更多" },
  { words: [yw("Let's go", "让我们出发", s("（Let's go）")), yw("hi-ka-ri-no", "光芒的", s("光", "ひかり"), s("の")), yw("mu-ko-u-e", "彼岸", s("向", "む"), s("こうへ")), yw("ho-ra", "来吧", s("ほら"))], zh: "现在向着光芒的彼岸" },
  { words: [yw("i-s-sho-ni-ne", "一同出发吧", s("いっしょにね"))], zh: "让我们一同出发吧" },
  { words: [yw("ka-e-ta-i-na", "想要改变", s("変", "か"), s("えたいな")), yw("my future", "我的未来", s("my future"))], zh: "想要改变我的未来" },
  { words: [yw("sa-a-do-ko-e", "现在要去往何处", s("（さあっどこへ）"))], zh: "(现在要去往何处)" },
  { words: [yw("ta-i-yo-u-ga", "太阳", s("太陽", "たいよう"), s("が")), yw("no-bo-ru", "升起", s("昇", "のぼ"), s("る")), yw("yo-u-ni", "如同……一般", s("ように"))], zh: "如初升的旭日般" },
  { words: [yw("yu-me-yo", "梦想啊", s("夢", "ゆめ"), s("よ")), yw("ka-ga-ya-i-te", "绽放光芒", s("輝", "かがや"), s("いて")), yw("charging heart", "蓄势待发的心", s("charging heart"))], zh: "梦想请绽放光芒 蓄势待发的心" },
  { words: [yw("chi-ka-ra-i-p-pa-i", "全力以赴", s("ちからいっぱい")), yw("ka-na-e-yo-u", "实现吧", s("叶", "かな"), s("えよう")), yw("ne-ga-i-o", "心愿", s("願", "ねが"), s("いを"))], zh: "全力以赴去实现心愿吧" },
  { words: [yw("se-i-shu-n", "青春", s("青春", "せいしゅん")), yw("pi-k-ka-ri-da", "熠熠生辉", s("ぴっかりだ"))], zh: "青春熠熠生辉" },
  { words: [yw("ka-e-ta-i-to", "想要改变", s("変", "か"), s("えたいと")), yw("o-mo-u", "渴望", s("思", "おも"), s("う")), yw("sunshine", "阳光使命", s("sunshine "))], zh: "渴望改变的心情" },
  { words: [yw("ki-mo-chi-ga", "心情", s("気持", "きも"), s("ちが")), yw("ki-t-to", "一定", s("きっと")), yw("da-i-ji-da-yo", "格外重要", s("だいじだよ"))], zh: "一定格外的重要" },
  { ...aozoraCatchDreamLine, zh: "一起去捕捉梦想" },
  aozoraTogetherLine,
  aozoraExplainLine,
  { words: [yw("da-i-jo-u-bu-sa", "一定没问题", s("だいじょうぶさ"))], zh: "但是我们一定没问题" },
  { words: [yw("Jumping heart", "跳跃的心", s("Jumping heart"))], zh: "Jumping heart", aside: true },
  { words: [yw("da-t-te", "因为", s("だって")), yw("ha-ji-me-ta-i", "想要开始", s("はじめたい")), yw("ko-to-ga", "事情", s("ことが"))], zh: "因为我才刚找到" },
  { words: [yw("Charging heart", "蓄势待发的心", s("Charging heart"))], zh: "Charging heart", aside: true },
  { words: [yw("i-ma", "现在", s("いま")), yw("mi-tsu-ka-t-ta", "找到了", s("見", "み"), s("つかった")), yw("ba-k-ka-ri", "才刚刚", s("ばっかり"))], zh: "自己想做的事情" },
  { words: [yw("goal-wa", "终点", s("ゴールは")), yw("do-ko-do-ko-da-ro-u", "在哪里、在哪里呢", s("どこどこだろう"))], zh: "终点在哪里 在哪里呢" },
  { words: [yw("wa-ka-ra-na-i", "无从知晓", s("わからない"))], zh: "虽然无从知晓" },
  { words: [yw("wa-ka-ra-na-i", "无从知晓", s("わからない")), yw("de-mo-ne", "但是呢", s("でもね")), yw("ta-no-shi-so-u-da-yo", "貌似很有趣", s("楽", "たの"), s("しそうだよ"))], zh: "但貌似会是趟很有趣的旅程" },
  aozoraStartStoryLine,
  aozoraBlueSkyLine,
  aozoraJumpingHeartLine,
  aozoraTomorrowLine,
  aozoraYouthLine,
  { words: [yw("ha-ji-ma-t-ta", "起航", s("はじまった")), yw("to-ki-no", "时刻的", s("時", "とき"), s("の"))], zh: "梦想起航时" },
  { words: [yw("Sunshine story", "阳光故事", s("（Sunshine story）"))], zh: "Sunshine story", aside: true },
  aozoraTokimekiLine,
  aozoraCatchDreamLine,
  { words: [yw("do-n-na-ko-to-ga", "怎样的事情", s("どんなことが")), yw("o-ko-ru-no-ka", "会发生", s("おこるのか"))], zh: "不知道未来" },
  { words: [yw("wa-ka-ra-na-i", "未知的", s("わからない")), yw("mi-ra-i", "未来", s("未来", "みらい"))], zh: "会发生什么" },
  { ...aozoraCatchDreamLine, zh: "一起去捕捉梦想" },
  aozoraTogetherLine,
  aozoraExplainLine,
  { words: [yw("da-i-jo-u-bu-sa", "一定没问题", s("だいじょうぶさ")), yw("ma-s-shi-gu-ra", "勇往直前", s("まっしぐら"))], zh: "但是我们一定没问题 勇往直前" },
];
...
const myMaiTonightLyrics: LyricLine[] = [
  cl("熱{あつ}く|なるため", "人生在世"),
  cl("人{ひと}は|生{う}まれた|はずさ", "莫不就是为了轰轰烈烈活一场"),
  cl("いま|小{ちい}さく|燃{も}えてる", "此刻正微弱燃烧的"),
  cl("まだ|小{ちい}さな|焔{ほむら}が", "依旧小小的火焰"),
  cl("一{ひと}つに|なれば", "若是融为一体"),
  cl("奇跡{きせき}が|生{う}まれ", "就会产生奇迹的吧"),
  cl("この|セカイは|いつも", "这世界总是如此"),
  cl("諦{あきら}めない|心{こころ}に", "那不肯放弃的心"),
  cl("答{こた}えじゃ|なく", "要的并不是答案"),
  cl("道{みち}を|探{さが}す", "既然上天给了我"),
  cl("手掛{てが}かりを", "寻找道路的"),
  cl("くれるから", "线索"),
  cl("最後{さいご}まで", "那么直到最后"),
  cl("強気{つよき}で|行{い}こう", "都坚定地前行吧"),
  cl("踊{おど}れ|踊{おど}れ", "舞动吧 舞动吧"),
  cl("熱{あつ}く|なるため", "人生在世"),
  cl("人{ひと}は|生{う}まれてきたの？", "莫不就是为了轰轰烈烈活一场？"),
  cl("踊{おど}れ|踊{おど}れ", "舞动吧 舞动吧"),
  cl("きっと|そうだよ", "一定就是如此"),
  cl("だから|夢見{ゆめみ}て|踊{おど}ろう", "所以梦想吧 舞动吧"),
  cl("My|舞{まい}|tonight", "我的舞蹈 今夜"),
  cl("Dancing tonight", "Dancing tonight", true),
  cl("最高{さいこう}の", "最绝妙的"),
  cl("My|舞{まい}|tonight", "我的舞蹈 今夜"),
  cl("Dancing tonight", "Dancing tonight", true),
  cl("今日{きょう}に|しよう", "就在今日吧"),
  cl("いつか|広{ひろ}がるだろう", "总有一天我的世界更大"),
  cl("ほら|大{おお}きく|広{ひろ}がれ", "看 不断扩张"),
  cl("頑張{がんば}る|力{ちから}|奇跡{きせき}を|呼{よ}んでる", "努力的意义会造就奇迹"),
  cl("この|世界{せかい}の|中{なか}で", "想要在这个世界"),
  cl("輝{かがや}きたい|心{こころ}が", "大放光彩的心"),
  cl("集{あつ}まる|時{とき}|新{あたら}しいこと|思{おも}いつき", "聚集之时 会迸发出新的火花"),
  cl("走{はし}り|出{だ}す|足元{あしもと}が|見{み}えないけど", "尽情奔跑 不顾一切"),
  cl("羽{はね}みたいに|手{て}|伸{の}ばして", "伸出双手 化作羽翼"),
  cl("踊{おど}れ|踊{おど}れ", "舞动吧 舞动吧"),
  cl("憧{あこが}れたのは", "一心所盼的是"),
  cl("ずっと|瞬{またた}く|光{ひかり}", "永远闪耀的光"),
  cl("踊{おど}れ|踊{おど}れ", "舞动吧 舞动吧"),
  cl("きっと|いつかは", "定会有那么一天"),
  cl("叶{かな}う|はずだと|踊{おど}ろう", "我的渴望得以实现 舞动吧"),
  cl("My|舞{まい}|tonight", "我的舞蹈 今夜"),
  cl("Dancing tonight", "Dancing tonight", true),
  cl("明日{あした}へと", "向着明天"),
  cl("My|舞{まい}|tonight", "我的舞蹈 今夜"),
  cl("Dancing tonight", "Dancing tonight", true),
  cl("繋{つな}げよう", "紧密相连吧"),
  cl("胸{むね}の|声{こえ}に|導{みちび}かれて", "遵循心底的声音"),
  cl("道{みち}が|まだ|開{ひら}けだよ", "将会开拓出新的道路"),
  cl("最後{さいご}まで|強気{つよき}で|いこう", "保持那一份硬气直到最后"),
  cl("踊{おど}れ|踊{おど}れ", "舞动吧 舞动吧"),
  cl("熱{あつ}く|なるため", "人生在世"),
  cl("人{ひと}は|生{う}まれてきたの？", "莫不就是为了轰轰烈烈活一场？"),
  cl("踊{おど}れ|踊{おど}れ", "舞动吧 舞动吧"),
...
const waterBlueNewWorldLyrics: LyricLine[] = [
  cl("今{いま}は|今{いま}で|昨日{きのう}と|違{ちが}うよ", "现在就是现在 不同于昨天"),
  cl("明日{あした}への|途中{とちゅう}じゃなく", "也不是前往明天的途中"),
  cl("今{いま}は|今{いま}だね", "现在就是现在啊"),
  cl("この|瞬間{しゅんかん}の|ことが", "这一瞬间的事情"),
  cl("重{かさ}なっては|消{き}えてく", "重叠又渐渐消失"),
  cl("心{こころ}に|刻{きざ}むんだ", "铭刻在心间"),
  cl("Water blue", "Water blue", true),
  cl("悔{く}やみたく|なかった", "不愿留有悔恨"),
  cl("気持{きも}ちの|先{さき}に", "漫游在内心里"),
  cl("広{ひろ}がった|世界{せかい}を", "广阔的"),
  cl("泳{およ}いできたのさ", "世界中"),
  cl("諦{あきら}めない", "绝不言弃"),
  cl("言{い}うだけでは|叶{かな}わない", "光是说说是不会实现的"),
  cl("動{うご}け", "行动吧"),
  cl("動{うご}けば|変{か}わるんだ", "行动起来就会改变"),
  cl("と|知{し}ったよ", "我明白的"),
  cl("ずっと", "虽然想要永远"),
  cl("ここに|いたいと|思{おも}ってるけど", "待在这里"),
  cl("きっと|旅立{たびだ}ってくって", "但我必须要踏上旅途"),
  cl("わかってるんだよ", "我明白的"),
  cl("だから|この|時{とき}を|楽{たの}しくしたい", "所以我想要好好享受这一刻"),
  cl("最高{さいこう}の|ときめきを", "将最美好的悸动"),
  cl("胸{むね}に|焼{や}き|付{つ}けたいから", "铭刻在心间"),
  cl("My new world |新{あたら}しい|場所{ばしょ}", "我的新世界 新地方"),
  cl("探{さが}す|時{とき}が|きたよ", "探险的时刻到来了"),
  cl("次{つぎ}の|輝{かがや}きへと", "渡过大海"),
  cl("海{うみ}を|渡{わた}ろう", "前往下一片光辉吧"),
  cl("夢{ゆめ}が|見{み}たい|想{おも}いは", "因为想要实现梦想的思绪"),
  cl("いつでも|僕{ぼく}たちを", "永远都会将我们"),
  cl("繋{つな}いでくれるから", "连结在一起"),
  cl("笑{わら}っていこう", "欢笑吧"),
  cl("今{いま}を|重{かさ}ね|そして", "将此刻重叠 然后"),
  cl("未来{みらい}へ|向{む}かおう", "面向未来吧"),
  cl("時{とき}は|今日{きょう}も|過{す}ぎてく", "时间今日也在不停逝去"),
  cl("止{と}められないと", "停不下来"),
  cl("気{き}が|付{つ}いた|僕{ぼく}らは", "回过神来"),
  cl("どこへ|向{む}かうの？", "我们要去往何方？"),
  cl("大丈夫{だいじょうぶ}", "没关系的"),
  cl("いつだって|思{おも}い|出{だ}せるよ", "无论何时都能够回想起来的"),
  cl("駆{か}け|抜{ぬ}けてきた", "奔跑穿过"),
  cl("素晴{すば}らしい|季節{きせつ}を", "美妙的季节"),
  cl("ずっと|ここに|いたいね", "想要永远在这里呢"),
  cl("好{す}きだよ|みんな", "所有人都好喜欢"),
  cl("でもね|旅立{たびだ}ってくって", "但是啊 我明白"),
  cl("分{わ}かってるんだよ", "自己要不断踏上旅途"),
  cl("たくさん|頑張{がんば}ってきた", "一路上付出了许多的努力"),
  cl("時間{じかん}が|愛{いと}しい", "那拼搏的时光是如此惹人喜爱"),
  cl("最高{さいこう}の", "将最美好的"),
  cl("繋{つな}がりを", "羁绊"),
  cl("いつまでも|大事{だいじ}にしよう", "永远好好珍惜吧"),
  cl("My new world", "My new world", true),
  cl("また|ココロが", "想要再次"),
  cl("躍{おど}るような|日々{ひび}を", "去追逐"),
  cl("追{お}いかけたい|気持{きも}ちで", "内心雀跃的日子 带着这样的心情"),
  cl("海{うみ}を|渡{わた}ろう", "渡过大海吧"),
  cl("夢{ゆめ}は|夢{ゆめ}のように", "梦想不仅仅是要如梦想那般"),
  cl("過{す}ごすだけじゃなくて", "度过每一天"),
  cl("痛{いた}み|抱{かか}えながら", "而是要一边怀抱痛楚"),
  cl("求{もと}めるものさ", "一边去寻求"),
  cl("今{いま}は|今{いま}で|昨日{きのう}と|違{ちが}うよ", "现在就是现在 不同于昨天"),
  cl("明日{あした}への|途中{とちゅう}じゃなく", "也不是前往明天的途中"),
  cl("今{いま}は|今{いま}だね", "现在就是现在啊"),
  cl("この|瞬間{しゅんかん}の|ことが", "这一瞬间的事情"),
  cl("重{かさ}なっては|消{き}えてく", "重叠又渐渐消失"),
  cl("ココロに|刻{きざ}むんだ", "铭刻在心间"),
  cl("Water blue", "Water blue", true),
  cl("New world", "New world", true),
  cl("新{あたら}しい|場所{ばしょ}", "全新的地方"),
  cl("探{さが}す|時{とき}が|来{き}たよ", "探险的时刻到来了"),
  cl("次{つぎ}の|輝{かがや}きへと", "渡过大海"),
  cl("海{うみ}を|渡{わた}ろう", "前往下一片光辉吧"),
  cl("夢{ゆめ}が|見{み}たい|想{おも}いは", "因为想要实现梦想的思绪"),
  cl("いつでも|僕{ぼく}たちを", "永远都会将我们"),
  ...
  cl("笑{わら}っていこう", "欢笑吧"),
  cl("ココロに|刻{きざ}むんだ", "铭刻在心间"),
  cl("この|瞬間{しゅんかん}の|ことを", "将这一瞬间的事情"),
  cl("ココロに|刻{きざ}むんだ", "铭刻在心间"),
  cl("この|瞬間{しゅんかん}の|ことを", "将这一瞬间的事情"),
  cl("僕{ぼく}らの|ことを", "将我们的事情"),
  cl("今{いま}を|重{かさ}ね", "将此刻重叠吧"),
  cl("そして|未来{みらい}へ|向{む}かおう", "然后向着未来前行吧"),
];
